...
В данном проекте используется паттерн проектирования "Состояние" (State), который обеспечивает управление различными состояниями бота для более гибкого и чистого кода.
